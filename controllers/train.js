...
const trainListService = require('../services/trainAll')
const trainCreateService = require('../services/trainCreate')
const trainByIdService = require("../services/trainById");
const trainDeleteService = require("../services/trainDelete");
const trainUpdateService = require("../services/trainUpdate");
