...
const passengerListService = require('../services/passengerAll')
const passengerCreateService = require('../services/passengerCreate')
const passengerByIdService = require("../services/passengerById");
const passengerDeleteService = require("../services/passengerDelete");
const passengerUpdateService = require("../services/passengerUpdate");
