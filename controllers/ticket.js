...
const passengerAllService = require('../services/passengerAll')
const trainAllService = require('../services/trainAll')
const ticketAllService = require('../services/ticketAll')
const ticketCreateService = require('../services/ticketCreate')
const ticketByIdService = require('../services/ticketById')
const ticketUpdateService = require('../services/ticketUpdate')
const ticketDeleteService = require("../services/ticketDelete");
